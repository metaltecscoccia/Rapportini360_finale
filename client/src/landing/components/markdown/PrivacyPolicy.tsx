...
- **Foto**: Immagini scattate o selezionate dalla galleria per documentare le attivita lavorative
...
I dati personali sono raccolti e trattati per le seguenti finalita:

### 4.1 Finalita principali (base giuridica: esecuzione del contratto)

- Gestione rapportini di lavoro giornalieri
- Tracciamento ore lavorate e presenze
- Documentazione fotografica delle attivita lavorative
- Gestione flotta veicoli e rifornimenti
- Generazione report per l'organizzazione di appartenenza

### 4.2 Finalita secondarie (base giuridica: legittimo interesse)

- Sicurezza dell'applicazione e prevenzione accessi non autorizzati
- Miglioramento delle funzionalita dell'App
- Supporto tecnico agli utenti

### 4.3 Finalita legali (base giuridica: obbligo di legge)

- Conservazione dati per obblighi fiscali e contabili (10 anni)
- Risposta a richieste delle autorita competenti

## 5. Base Giuridica del Trattamento

Il trattamento dei dati personali e basato su:
...
- **Finalita**: Archiviazione e gestione foto
...
- **Finalita**: Hosting dell'applicazione e database
...
- Societa di marketing o pubblicita
- Broker di dati
- Social network
...
- **Account attivi**: I dati vengono conservati finche l'account e attivo
...
- Monitoraggio accessi e attivita sospette
...
Dove il trattamento e basato sul consenso, puoi revocarlo in qualsiasi momento.

### 9.8 Diritto di reclamo

Puoi presentare reclamo all'Autorita Garante per la Protezione dei Dati Personali:
...
L'App non e destinata a minori di 16 anni. Non raccogliamo consapevolmente dati di minori.

## 14. Modifiche all'Informativa

Questa informativa puo essere aggiornata periodicamente. Le modifiche sostanziali saranno comunicate tramite:
- Notifica in-app
