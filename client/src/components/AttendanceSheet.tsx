                        ...
                        <TableRow key={`${employee.userId}-overtime`} className="border-b-2">
                          ...
                          {Array.from({ length: daysInMonth }, (_, i) => {
                            ...
                            return (
                              <TableCell 
                                key={day} 
                                className={`text-center p-0.5 text-xs cursor-pointer hover-elevate relative group ${getCellBgColor(selectedYear, selectedMonth, day)}`}
                                onClick={() => handleCellClick(employee.userId, employee.fullName, day)}
